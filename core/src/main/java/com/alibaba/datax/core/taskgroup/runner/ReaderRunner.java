...
public class ReaderRunner extends AbstractRunner implements Runnable {
    ...
    private List<RecordSender> recordSenders;

    public void setRecordSender(List<RecordSender> recordSenders) {
    ...
    @Override
    public void run() {
        assert null != this.recordSenders;
        ...
        try {
            ...
            taskReader.startRead(recordSenders);
