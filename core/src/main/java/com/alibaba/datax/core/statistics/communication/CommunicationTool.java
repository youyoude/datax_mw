...
public final class CommunicationTool {
    ...
    public static class Stringify {
        private final static DecimalFormat df = new DecimalFormat("0.00");
         /**
         StandAloneJobContainerCommunicator - Total 90357 records, 11812953 bytes | Speed 384.54KB/s, 3011 records/s | Error 0 records, 0 bytes |
          All Task WaitWriterTime 0.004s |  All Task WaitReaderTime 17.242s | Percentage 100.00%
          */
