...
//DATAX_JOB_CONTENT  split之后的task 对应数量的配置
//        for (Configuration configuration1:contentConfig){
//            LOG.info("assignFairly begin contentConfig={}",configuration1);
//        }
...
//        for (Configuration configuration1:taskGroupConfig){
//            LOG.info("assignFairly end contentConfig={}",configuration1);
//        }
