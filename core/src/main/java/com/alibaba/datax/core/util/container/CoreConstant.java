...
public class CoreConstant {
	...
	public static  Map<String,Channel> CHANNELCACHE=new ConcurrentHashMap<String, Channel>();
	public static  Map<String,ArrayBlockingQueue<Record>> QUEUECACHE=new ConcurrentHashMap<String, ArrayBlockingQueue<Record>>();
	public static  Map<String, ReentrantLock> LOCKCACHE=new ConcurrentHashMap<String, ReentrantLock>();

	public static  Map<String, Condition> CONDITIONnotInsufficientCACHE=new ConcurrentHashMap<String, Condition>();

	public static  Map<String, Condition> CONDITIONnotEmptyCACHE=new ConcurrentHashMap<String, Condition>();
	...
	public static final String DATAX_JOB_CONTENT_WRITER_NAME = "job.content[0].writer";

	public static final String DATAX_JOB_CONTENT_WRITER_PARAMETER = "job.content[0].writer";
