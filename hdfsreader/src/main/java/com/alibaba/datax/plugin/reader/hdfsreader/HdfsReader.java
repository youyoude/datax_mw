...
public class HdfsReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public List<Configuration> split(int adviceNumber) {
            ...
            LOG.info("split() begin...{}",splitNumber);
            ...
            for (List<String> files : splitedSourceFiles) {
                LOG.info("split() begin...files = {}",files.toString());
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(List<RecordSender> recordSenders) {
            ...
            LOG.info("read start {}",this.sourceFiles);
            for (String sourceFile : this.sourceFiles) {
                ...
                if(specifiedFileType.equalsIgnoreCase(Constant.TEXT)
                    ...
                    UnstructuredStorageReaderUtil.readFromStream(inputStream, sourceFile, this.taskConfig,
                    		recordSenders, this.getTaskPluginCollector());
                }else if(specifiedFileType.equalsIgnoreCase(Constant.ORC)){

                    dfsUtil.orcFileStartRead(sourceFile, this.taskConfig, recordSenders, this.getTaskPluginCollector());
                }else if(specifiedFileType.equalsIgnoreCase(Constant.SEQ)){

                    dfsUtil.sequenceFileStartRead(sourceFile, this.taskConfig, recordSenders, this.getTaskPluginCollector());
                }else if(specifiedFileType.equalsIgnoreCase(Constant.RC)){

                    dfsUtil.rcFileStartRead(sourceFile, this.taskConfig, recordSenders, this.getTaskPluginCollector());
                }else {
                ...
                LOG.info("end read source files... {}",sourceFile);
