...
public class DFSUtil {
    ...
    public void sequenceFileStartRead(String sourceSequenceFilePath, Configuration readerSliceConfig,
                                      List<RecordSender> recordSenders, TaskPluginCollector taskPluginCollector) {
...
//                    LOG.info("准备发送 recordSenders ={}",recordSenders.toString());

                    for( RecordSender recordSender:recordSenders){
//                        LOG.info(" 发送{}",recordSender.toString());
