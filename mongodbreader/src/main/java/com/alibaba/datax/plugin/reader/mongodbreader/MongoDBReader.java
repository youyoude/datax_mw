                ...
                while (dbCursor.hasNext()) {
                    ...
                    for(RecordSender recordSender:recordSenders){
                         ...
                         while (columnItera.hasNext()) {
                             ...
                             if (tempCol == null) {
                                 if (column.getString(KeyConstant.COLUMN_TYPE).equals("double"))
                                     record.addColumn(new DoubleColumn(Double.valueOf(0.0D)));
                                 if (column.getString(KeyConstant.COLUMN_TYPE).equals("string"))
                                     record.addColumn(new StringColumn(""));
                                 if (column.getString(KeyConstant.COLUMN_TYPE).equals("long"))
                                     record.addColumn(new LongColumn(Long.valueOf(0L)));
                                 continue;
                             }
