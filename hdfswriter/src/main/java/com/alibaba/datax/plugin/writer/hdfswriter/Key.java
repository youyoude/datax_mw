...
//    public final static String INTERNAL = "internal";
    ...
    public static final String HIVE_DB = "dbName";
    public static final String HIVE_TABLE = "tableName";
    public static final String HIVE_TABLE_PARTITION_COLUMN = "partitionColumn";
    public static final String HIVE_TABLE_PARTITION_VALUE = "partitionValue";
